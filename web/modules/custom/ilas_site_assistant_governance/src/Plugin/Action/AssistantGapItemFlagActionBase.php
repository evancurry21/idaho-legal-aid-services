...
/**
 * Base class for assistant gap-item secondary-flag actions.
 */
abstract class AssistantGapItemFlagActionBase extends ActionBase implements ContainerFactoryPluginInterface {
   ...
   */
  abstract protected function secondaryFlag(): string;
  ...
  public function execute($entity = NULL): void {
    ...
    $entity->addSecondaryFlag($this->secondaryFlag());
  ...
  public function access($object, ?AccountInterface $account = NULL, $return_as_object = FALSE) {
    ...
    $allowed = $object instanceof AssistantGapItem
      && ($account->hasPermission('flag assistant gap items') || $account->hasPermission('administer assistant gap items'));
