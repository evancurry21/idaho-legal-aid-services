...
class AssistantReportController extends ControllerBase {
  ...
  protected function buildRuntimeTruthStatusSection() {
    ...
    $coreRows = [
      ...
      $this->buildStatusRow($this->t('Assistant Request-Time LLM Retired'), $stored['llm']['request_time_retired'] ?? NULL, $effective['llm']['request_time_retired'] ?? NULL, $overrideChannels['llm.request_time_retired'] ?? 'Assistant request-time LLM retirement contract'),
      $this->buildStatusRow($this->t('Assistant Google Generation Reachable'), $stored['llm']['google_generation_reachable'] ?? NULL, $effective['llm']['google_generation_reachable'] ?? NULL, $overrideChannels['llm.google_generation_reachable'] ?? 'Assistant request-time LLM retirement contract'),
      ...
      $this->buildStatusRow($this->t('Embeddings Provider'), $stored['embeddings']['provider_id'] ?? NULL, $effective['embeddings']['provider_id'] ?? NULL, $overrideChannels['embeddings.provider_id'] ?? 'config export'),
      $this->buildStatusRow($this->t('Embeddings Model'), $stored['embeddings']['model_id'] ?? NULL, $effective['embeddings']['model_id'] ?? NULL, $overrideChannels['embeddings.model_id'] ?? 'config export'),
      $this->buildStatusRow($this->t('Embeddings API Key Present'), $stored['embeddings']['api_key_present'] ?? NULL, $effective['embeddings']['api_key_present'] ?? NULL, $overrideChannels['embeddings.api_key_present'] ?? 'config export'),
      $this->buildStatusRow($this->t('Embeddings Runtime Ready'), $stored['embeddings']['runtime_ready'] ?? NULL, $effective['embeddings']['runtime_ready'] ?? NULL, $overrideChannels['embeddings.runtime_ready'] ?? 'config export'),
    ...
    $observabilityRows = [
      ...
      $this->buildStatusRow($this->t('Langfuse Redacted Preview Enabled'), $stored['langfuse']['redacted_preview_enabled'] ?? NULL, $effective['langfuse']['redacted_preview_enabled'] ?? NULL, $overrideChannels['langfuse.redacted_preview_enabled'] ?? 'config export'),
      $this->buildStatusRow($this->t('Langfuse Redacted Preview Max Chars'), $stored['langfuse']['redacted_preview_max_chars'] ?? NULL, $effective['langfuse']['redacted_preview_max_chars'] ?? NULL, $overrideChannels['langfuse.redacted_preview_max_chars'] ?? 'config export'),
      ...
      $this->buildStatusRow($this->t('Pinecone Runtime Ready'), $stored['pinecone']['runtime_ready'] ?? NULL, $effective['pinecone']['runtime_ready'] ?? NULL, $overrideChannels['pinecone.runtime_ready'] ?? 'config export'),
